...
class HighchartsWidget extends CWidget
{
    ...
    protected static $_baseScript = 'highcharts';
    ...
    public $setupOptions = array(
        ...
        'lang' => array(
            'numericSymbols' => array("т" , "М" , "G" , "T" , "P" , "E"),
    ...
    {
        if (!$this->options) {
            self::registerCoreScripts();
            return;
        }
        if (isset($this->htmlOptions['id'])) {
            $id = $this->htmlOptions['id'];
        } else {
            $id = $this->htmlOptions['id'] = 'hc_'.$this->getId();
        }
        ...
        array_unshift($this->scripts, static::$_baseScript);

        $jsOptions = CJavaScript::encode($this->options);
        $setupOptions = CJavaScript::encode($this->setupOptions);

//        HDev::log($this->options);
    ...
    protected function registerScripts($id, $embeddedScript)
    {
        ...
        echo '<script type="text/javascript">'.$embeddedScript.'</script>';
    }
    ...
    public static function registerCoreScripts()
    {
        ...
        $scripts = array(static::$_baseScript);
